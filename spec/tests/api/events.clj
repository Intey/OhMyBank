...
(t/describe "When requested"
            ...
            (t/it (str "not exists path, SHOULD: Content-Type == "
                  ...
                  (t/should=
                     ...
                     (select-keys
                       (engine (mock/content-type
                                 (mock/request :get "/unexists") content-json))
                       [:status :headers])))
                  ...
                  (t/should=
                    ...
                    {:status 200
                     ...
                     (json/generate-string
                       [
                        {:id 1 :name "Cookies" :date "2016-01-10" :price  124.0
                         :author   "Intey" :status "initial" :parts 0 :rest 0 }
                        {:id 2 :name     "Tea" :date "2016-01-10" :price   50.0
                         :author "andreyk" :status "initial" :parts 0 :rest 0 }
                        {:id 3 :name   "Pizza" :date "2016-01-10" :price 1300.0
